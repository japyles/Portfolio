      ...
      <div>
        ...
        <div className='w-screen flex justify-center'>
          ...
          <div className='md:w-full w-1/2 p-10 shadow-2xl bg-gray-50'>
            ...
            <textarea placeholder='Query' className='w-full border-2 border-gray-400 rounded p-1 shadow-lg mt-5' />
            <button type='submit' className='bg-red-500 rounded text-white px-5 py-1 mt-3'>Submit</button>
          </div>
